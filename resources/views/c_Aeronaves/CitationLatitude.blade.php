                        ...
                        <div class="new-carousel-container">
                            <div class="new-carousel-track">
                                <div class="new-carousel-slide current-slide">
                                    <img src="{{ asset('img/aeronaves/aviones/Citation-Latitude-1.webp') }}" alt="Citation Latitude Vista Exterior" class="carousel-image">
                                </div>
                                <div class="new-carousel-slide">
                                    <img src="{{ asset('img/aeronaves/aviones/Citation-Latitude-2.webp') }}" alt="Citation Latitude Cabina Interior" class="carousel-image">
                                </div>
                                <div class="new-carousel-slide">
                                    <img src="{{ asset('img/aeronaves/aviones/Citation-Latitude-3.webp') }}" alt="Citation Latitude Cockpit" class="carousel-image">
                                </div>
                                <div class="new-carousel-slide">
                                    <img src="{{ asset('img/aeronaves/aviones/Citation-Latitude-4.webp') }}" alt="Citation Latitude en Vuelo" class="carousel-image">
                                </div>
                            </div>
                        </div>
                ...
                <section class="aircraft-capacity">
                    ...
                    <div class="capacity-layout">
                        ...
                        <div class="seating-diagram">
                            <img src="{{ asset('img/aeronaves/aviones/Citation-Latitude.webp') }}" alt="Citation Latitude Diagrama" style="width: 100%; height: 100%; border-radius: 10px; object-fit: cover;">
                        </div>
                    </div>
                </section>
