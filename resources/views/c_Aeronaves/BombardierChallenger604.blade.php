...
@section('content')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.body.classList.add('Challenger604-LargeJet');
        });
    </script>
