                ...
                <div class="header-left-panel">
                    <div class="aircraft-title-section-enhanced">
                        ...
                        <h1 class="aircraft-model-enhanced">
                            ...
                            <span class="model-variant">850</span>
                        </h1>
                        ...
                        <div class="credentials-frame">
                            <div class="credential-item-enhanced">
                                ...
                                <div class="credential-content">
                                    ...
                                    <span class="credential-value">850 km/h</span>
                                </div>
                            </div>
                            ...
                            <div class="credential-item-enhanced">
                                ...
                                <div class="credential-content">
                                    ...
                                    <span class="credential-value">24,041 kg</span>
                                </div>
                            </div>
                            <div class="credential-divider"></div>
                            <div class="credential-item-enhanced">
                                ...
                                <div class="credential-content">
                                    ...
                                    <span class="credential-value">12-16 pax</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <section class="aircraft-description">
                    ...
                    <p class="description-text">
                        El Challenger 850 es el jet ejecutivo más grande de la serie Challenger, basado en el avión regional CRJ200. Ofrece cabina espaciosa para hasta 16 pasajeros, con confort de nivel corporativo y un alcance intercontinental, combinando lujo, eficiencia y gran capacidad de transporte.
                    </p>
                    <p class="description-text">
                        <strong>Autonomía Máxima:</strong> ~5,206 km (2,812 nm)
                    </p>
                </section>
                        ...
                        <div class="new-carousel-container">
                            <div class="new-carousel-track">
                                <div class="new-carousel-slide current-slide">
                                    <img src="{{ asset('img/aeronaves/aviones/Challenger-850-1.webp') }}" alt="Challenger 850 Vista Exterior" class="carousel-image">
                                </div>
                                <div class="new-carousel-slide">
                                    <img src="{{ asset('img/aeronaves/aviones/Challenger-850-2.webp') }}" alt="Challenger 850 Cabina Interior" class="carousel-image">
                                </div>
                                <div class="new-carousel-slide">
                                    <img src="{{ asset('img/aeronaves/aviones/Challenger-850-3.webp') }}" alt="Challenger 850 Cockpit" class="carousel-image">
                                </div>
                                <div class="new-carousel-slide">
                                    <img src="{{ asset('img/aeronaves/aviones/Challenger-850-4.webp') }}" alt="Challenger 850 en Vuelo" class="carousel-image">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="capacity-layout">
                        <div class="capacity-info">
                            <div class="capacity-item">
                                ...
                                <div>
                                    <h3>Capacidad</h3>
                                    <p>2 tripulantes + 12 a 16 pasajeros (máximo 16)</p>
                                </div>
                            </div>
                            <div class="capacity-item">
                            ...
                            <div class="capacity-item">
                                ...
                                <div>
                                    ...
                                    <p>~1,500 – 1,800 kg incluyendo equipaje</p>
                                </div>
                            </div>
                            <div class="capacity-item">
                        ...
                        <div class="seating-diagram">
                            <img src="{{ asset('img/aeronaves/aviones/Challenger-850.webp') }}" alt="Challenger 850 Diagrama" style="width: 100%; height: 100%; border-radius: 10px; object-fit: cover;">
                        </div>
                    </div>
                </section>
                ...
                <section class="aircraft-operations">
                    ...
                    <div class="operations-content">
                        <div class="operations-text">
                            <p>El Challenger 850 opera en las principales rutas nacionales e intercontinentales, 
                            conectando destinos estratégicos en Peru y el extranjero con gran capacidad y confort para vuelos corporativos de largo alcance.</p>
                        </div>
                        <div class="routes-grid">
                            ...
                            <div class="route-item">
                                ...
                                <ul>
                                    ...
                                    <li>Vuelos Intercontinentales</li>
                                    <li>Transporte Ejecutivo de Gran Capacidad</li>
                                </ul>
                            </div>
                        </div>
                    </div>
