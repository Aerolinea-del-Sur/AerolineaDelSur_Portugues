...
@section('content')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.body.classList.add('beechcraft-1900d');
        });
    </script>
                        ...
                        <div class="credentials-frame">
                            <div class="credential-item-enhanced">
                                ...
                                <div class="credential-content">
                                    ...
                                    <span class="credential-value">526 km/h</span>
                                </div>
                            </div>
                            ...
                            <div class="credential-item-enhanced">
                                ...
                                <div class="credential-content">
                                    ...
                                    <span class="credential-value">7,764 kg</span>
                                </div>
                            </div>
                            <div class="credential-divider"></div>
                            <div class="credential-item-enhanced">
        ...
        <aside class="sticky-form">
            <div class="form-container">
                ...
                <form class="contact-form" id="aircraftForm" method="POST"
                    ...
                    <div class="form-group">
                        <input type="text" id="aircraft" name="aircraft" value="Beechcraft 1900D" readonly required>
                    </div>
                    <div class="form-group">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const animatedElements = document.querySelectorAll(
                'section, .overview-item, .performance-item, .route-item');
