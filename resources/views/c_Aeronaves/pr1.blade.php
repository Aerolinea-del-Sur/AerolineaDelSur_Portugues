                    ...
                    <div class="operations-content">
                        ...
                        <div class="routes-grid">
                            <div class="route-item">
                                ...
                                <ul>
                                    <li>Ciudad de México - Guadalajara</li>
                                    <li>Ciudad de México - Monterrey</li>
                                    <li>Ciudad de México - Cancún</li>
                                    <li>Guadalajara - Tijuana</li>
                                </ul>
                            </div>
                            <div class="route-item">
                                <i class="fas fa-globe-americas"></i>
                                <h3>Rutas Internacionales</h3>
                                <ul>
                                    <li>Ciudad de México - Miami</li>
                                    <li>Ciudad de México - Los Angeles</li>
                                    <li>Guadalajara - Chicago</li>
                                    <li>Monterrey - Houston</li>
                                </ul>
                            </div>
                            <div class="route-item">
                                <i class="fas fa-plane-departure"></i>
                                <h3>Destinos Especiales</h3>
                                <ul>
