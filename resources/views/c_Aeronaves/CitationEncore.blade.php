                        ...
                        <div class="credentials-frame">
                            <div class="credential-item-enhanced">
                                ...
                                <div class="credential-content">
                                    ...
                                    <span class="credential-value">796 km/h</span>
                                </div>
                            </div>
                            ...
                            <div class="credential-item-enhanced">
                                ...
                                <div class="credential-content">
                                    ...
                                    <span class="credential-value">7,167 kg</span>
                                </div>
                            </div>
                            <div class="credential-divider"></div>
                            <div class="credential-item-enhanced">
        ...
        <aside class="sticky-form">
            <div class="form-container">
                ...
                @csrf
                    ...
                    <div class="form-group">
                        <input type="text" id="aircraft" name="aircraft" value="Citation Encore" readonly required>
                    </div>
                    <div class="form-group">
