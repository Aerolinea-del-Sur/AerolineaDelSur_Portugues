...
@section('content')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.body.classList.add('phenom-100');
        });
    </script>
                ...
                <div class="header-left-panel">
                    <div class="aircraft-title-section-enhanced">
                        ...
                        <h1 class="aircraft-model-enhanced">
                            ...
                            <span class="model-variant">100</span>
                        </h1>
                        ...
                        <div class="credentials-frame">
                            <div class="credential-item-enhanced">
                                ...
                                <div class="credential-content">
                                    ...
                                    <span class="credential-value">722 km/h</span>
                                </div>
                            </div>
                            ...
                            <div class="credential-item-enhanced">
                                ...
                                <div class="credential-content">
                                    ...
                                    <span class="credential-value">4,800 kg</span>
                                </div>
                            </div>
                            <div class="credential-divider"></div>
                            <div class="credential-item-enhanced">
            ...
            <div class="container">
                ...
                <section class="aircraft-description">
                    ...
                    <p class="description-text">
                        El Embraer Phenom 100 es un jet ejecutivo muy ligero desarrollado por la compañía brasileña Embraer y 
                        lanzado en 2007. Es uno de los aviones más populares de su categoría, ofreciendo una excelente relación 
                        entre costo operativo, comodidad y tecnología. Su diseño prioriza la eficiencia aerodinámica, con 
                        motores Pratt & Whitney PW617F-E que permiten un rendimiento sólido en rutas cortas y regionales.
                    </p>
                    <p class="description-text">
                        Su cabina, equipada con aviónica Garmin G1000 (o G3000 en versiones más nuevas), proporciona al piloto 
                        sistemas avanzados de gestión de vuelo y gran facilidad de operación. Con espacio para hasta 6 ocupantes, 
                        el Phenom 100 ofrece confort, seguridad y un consumo de combustible optimizado, lo que lo convierte en 
                        una de las opciones más atractivas para vuelos ejecutivos cortos de 2 a 3 horas. 
                    </p>
                </section>
                ...
                <section class="aircraft-operations">
                    ...
                    <div class="operations-content">
                        <div class="operations-text">
                            <p>El Phenom 100 opera en las principales rutas nacionales, 
        ...
        <aside class="sticky-form">
            <div class="form-container">
                ...
                <form class="contact-form" id="aircraftForm">
                    ...
                    <div class="form-group">
                        <input type="text" id="aircraft" name="aircraft" value="Phenom 100" readonly required>
                    </div>
                    <div class="form-group">
