                ...
                <div class="header-left-panel">
                    <div class="aircraft-title-section-enhanced">
                        ...
                        <h1 class="aircraft-model-enhanced">
                            <span class="model-number">Mi 8</span>
                            <span class="model-variant">MTV</span>
                        </h1>
            ...
            <div class="container">
                ...
                <section class="aircraft-description">
                    ...
                    <p class="description-text">
                        El Mi-8MTV es una versión modernizada y mejorada del clásico helicóptero soviético Mi-8, creado 
                        para operar en las condiciones más exigentes: mayores altitudes, temperaturas extremas y terrenos 
                        montañosos como los del Cáucaso, Asia Central o los Andes..
                    </p>
                    <p class="description-text">
                        Gracias a su gran capacidad de carga interna y externa, su amplia cabina y su autonomía operativa, 
                        el Mi-8 MTV es utilizado para una enorme variedad de misiones, tanto militares como civiles. Su diseño 
                        es robusto y sencillo de mantener, lo que le ha dado una reputación de confiabilidad en zonas remotas, 
                        desérticas, selváticas o montañosas.
                    </p>
                </section>
                ...
                <section class="aircraft-overview">
                    ...
                    <div class="overview-grid">
                        ...
                        <div class="overview-item">
                            ...
                            <h3>Fabricante</h3>
                            <p>Mil Moscow Helicopter Plant</p>
                        </div>
                    </div>
                </section>
                ...
                <section class="aircraft-operations">
                    ...
                    <div class="operations-content">
                        <div class="operations-text">
                            <p>El Mi-8 MTV opera en las principales rutas nacionales, 
