...
@section('content')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.body.classList.add('Challenger601-LargeJet');
        });
    </script>
        ...
        <main class="aircraft-content">
            <div class="container">
                ...
                <section class="aircraft-description">
                    <h2 class="section-title">Descripción del Avión</h2>
                    <p class="description-text">
                        El Challenger 601 es un jet ejecutivo de cabina ancha, desarrollado por Canadair (posteriormente Bombardier). Con espacio para hasta 12 pasajeros, ofrece gran confort en vuelos de largo alcance, destacando por su robustez, autonomía intercontinental y prestaciones de un jet de negocios de categoría superior.
                    </p>
                    <p class="description-text">
                        El Challenger 601 se introdujo a inicios de los años 80 como evolución del Challenger 600, incorporando motores General Electric CF34 más eficientes y mejoras en aviónica y sistemas de control. Se convirtió en un referente entre los jets de cabina ancha ejecutivos, con espacio cómodo para 9 a 12 pasajeros, ideal para vuelos transcontinentales sin escalas.
                    </p>
                    <p class="description-text">
                        Gracias a su cabina amplia, versatilidad y autonomía de más de 6 000 km, el Challenger 601 ha sido elegido tanto por clientes privados como por gobiernos y operadores corporativos. Su techo de crucero de 12 500 m y velocidad cercana a los 850 km/h lo colocan como un avión confiable y competitivo en su segmento durante más de dos décadas de producción.
                    </p>
                    <p class="description-text">
                        ...
                        <div class="new-carousel-container">
                            <div class="new-carousel-track">
                                <div class="new-carousel-slide current-slide">
                                    <img src="public/img/aeronaves/aviones/Challenger601-1.webp" alt="" class="carousel-image">
                                </div>
                                <div class="new-carousel-slide">
                                    <img src="public/img/aeronaves/aviones/Challenger601-2.webp" alt="" class="carousel-image">
                                </div>
                                <div class="new-carousel-slide">
                                    <img src="public/img/aeronaves/aviones/Challenger601-3.webp" alt="" class="carousel-image">
                                </div>
                                <div class="new-carousel-slide">
                                    <img src="public/img/aeronaves/aviones/Challenger601-4.webp" alt="" class="carousel-image">
                                </div>
                            </div>
                        </div>
                ...
                <section class="aircraft-capacity">
                    ...
                    <div class="capacity-layout">
                        ...
                        <div class="seating-diagram">
                            <img src="public/img/aeronaves/aviones/Challenger601.webp" alt="" style="width: 100%; height: 100%; border-radius: 10px; object-fit: cover;">
                        </div>
                    </div>
                </section>
