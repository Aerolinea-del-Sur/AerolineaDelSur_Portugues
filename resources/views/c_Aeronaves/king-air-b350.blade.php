...
@section('content')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.body.classList.add('air-king-b350');
        });
    </script>
                        ...
                        <div class="credentials-frame">
                            <div class="credential-item-enhanced">
                                ...
                                <div class="credential-content">
                                    ...
                                    <span class="credential-value">578 km/h</span>
                                </div>
                            </div>
                            ...
                            <div class="credential-item-enhanced">
                                ...
                                <div class="credential-content">
                                    ...
                                    <span class="credential-value">6,804 kg</span>
                                </div>
                            </div>
                            <div class="credential-divider"></div>
                            <div class="credential-item-enhanced">
                            ...
                            <div class="new-carousel-track">
                                ...
                                <div class="new-carousel-slide">
                                    ...
                                    <scripttype="application/ld+json">
                                    {
                                        ...
                                        "caption": "beechcraft king air 350i",
                                        "representativeOfPage": true,
                                        "datePublished": "2025-11-14"
                                    }
                                    </script>
        ...
        <aside class="sticky-form">
            <div class="form-container">
                ...
                <form class="contact-form" id="aircraftForm" method="POST"
                    ...
                    <div class="form-group">
                        <input type="text" id="aircraft" name="aircraft" value="King Air B350" readonly required>
                    </div>
                    <div class="form-group">
