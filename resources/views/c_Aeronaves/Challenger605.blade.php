...
@section('content')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.body.classList.add('challenger-605');
        });
    </script>
                ...
                <div class="header-left-panel">
                    <div class="aircraft-title-section-enhanced">
                        ...
                        <h1 class="aircraft-model-enhanced">
                            ...
                            <span class="model-variant">605</span>
                        </h1>
            ...
            <div class="container">
                ...
                <section class="aircraft-description">
                    ...
                    <p class="description-text">
                        El Bombardier Challenger 605 fue lanzado en 2006 como reemplazo del 604, manteniendo la 
                        plataforma robusta de la serie Challenger pero con significativas mejoras en cabina, diseño 
                        interior y sistemas de aviónica Rockwell Collins Pro Line 21. Está diseñado para transportar 
                        hasta 12 pasajeros en un ambiente lujoso y silencioso, con mayor espacio para ventanas y cabina 
                        rediseñada.
                    </p>
                    <p class="description-text">
                        Con un alcance cercano a los 8 000 km y techo operativo de 12 500 m, este jet puede conectar 
                        sin escalas ciudades intercontinentales como Nueva York – Londres o Dubái – París. Su consumo
                        eficiente y confiabilidad lo posicionan como uno de los modelos más demandados en el segmento 
                        de jets ejecutivos de cabina ancha.
                    </p>
                </section>
                ...
                <section class="aircraft-operations">
                    ...
                    <div class="operations-content">
                        <div class="operations-text">
                            <p>El Challenger 605 opera en las principales rutas nacionales, 
        ...
        <aside class="sticky-form">
            <div class="form-container">
                ...
                <form class="contact-form" id="aircraftForm">
                    ...
                    <div class="form-group">
                        <input type="text" id="aircraft" name="aircraft" value="Challenger 605" readonly required>
                    </div>
                    <div class="form-group">
