...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- METAETIQUETAS -->
            ...
            <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('public/img/service/favicon_io/apple-touch-icon.png') }}">
            <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('public/img/service/favicon_io/favicon-32x32.png') }}">
            <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('public/img/service/favicon_io/favicon-16x16.png') }}">
            <link rel="manifest" href="{{ asset('public/img/service/favicon_io/site.webmanifest') }}">
