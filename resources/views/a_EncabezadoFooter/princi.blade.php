...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            .nav-menu li a { color: var(--pearl); text-decoration: none; font-size: 13px; font-weight: 600; text-transform: uppercase; transition: var(--transition); position: relative; }
